...
- Core concept and terminology for data types.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing data types.
...
1. Implement a beginner-level data types exercise.
...
1. What is data types and why does it matter?
2. What are common pitfalls in data types?
3. How do you test and validate data types behavior?
4. How does data types affect performance?
5. What design principles apply most strongly to data types?
