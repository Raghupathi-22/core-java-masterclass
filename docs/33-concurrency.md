...
- Core concept and terminology for concurrency.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing concurrency.
...
1. Implement a beginner-level concurrency exercise.
...
1. What is concurrency and why does it matter?
2. What are common pitfalls in concurrency?
3. How do you test and validate concurrency behavior?
4. How does concurrency affect performance?
5. What design principles apply most strongly to concurrency?
