...
- Core concept and terminology for arrays.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing arrays.
...
1. Implement a beginner-level arrays exercise.
...
1. What is arrays and why does it matter?
2. What are common pitfalls in arrays?
3. How do you test and validate arrays behavior?
4. How does arrays affect performance?
5. What design principles apply most strongly to arrays?
