...
- Core concept and terminology for multithreading.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing multithreading.
...
1. Implement a beginner-level multithreading exercise.
...
1. What is multithreading and why does it matter?
2. What are common pitfalls in multithreading?
3. How do you test and validate multithreading behavior?
4. How does multithreading affect performance?
5. What design principles apply most strongly to multithreading?
