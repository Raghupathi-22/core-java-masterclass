...
- Core concept and terminology for exception handling.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing exception handling.
...
1. Implement a beginner-level exception handling exercise.
...
1. What is exception handling and why does it matter?
2. What are common pitfalls in exception handling?
3. How do you test and validate exception handling behavior?
4. How does exception handling affect performance?
5. What design principles apply most strongly to exception handling?
