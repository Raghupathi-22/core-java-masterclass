...
- Core concept and terminology for static keyword.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing static keyword.
...
1. Implement a beginner-level static keyword exercise.
...
1. What is static keyword and why does it matter?
2. What are common pitfalls in static keyword?
3. How do you test and validate static keyword behavior?
4. How does static keyword affect performance?
5. What design principles apply most strongly to static keyword?
