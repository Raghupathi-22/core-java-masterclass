...
- Core concept and terminology for inner classes.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing inner classes.
...
1. Implement a beginner-level inner classes exercise.
...
1. What is inner classes and why does it matter?
2. What are common pitfalls in inner classes?
3. How do you test and validate inner classes behavior?
4. How does inner classes affect performance?
5. What design principles apply most strongly to inner classes?
