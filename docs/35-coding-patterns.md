...
- Core concept and terminology for coding patterns.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing coding patterns.
...
1. Implement a beginner-level coding patterns exercise.
...
1. What is coding patterns and why does it matter?
2. What are common pitfalls in coding patterns?
3. How do you test and validate coding patterns behavior?
4. How does coding patterns affect performance?
5. What design principles apply most strongly to coding patterns?
