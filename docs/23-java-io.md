...
- Core concept and terminology for java io.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing java io.
...
1. Implement a beginner-level java io exercise.
...
1. What is java io and why does it matter?
2. What are common pitfalls in java io?
3. How do you test and validate java io behavior?
4. How does java io affect performance?
5. What design principles apply most strongly to java io?
