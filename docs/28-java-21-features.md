...
- Core concept and terminology for java 21 features.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing java 21 features.
...
1. Implement a beginner-level java 21 features exercise.
...
1. What is java 21 features and why does it matter?
2. What are common pitfalls in java 21 features?
3. How do you test and validate java 21 features behavior?
4. How does java 21 features affect performance?
5. What design principles apply most strongly to java 21 features?
