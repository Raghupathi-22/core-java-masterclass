...
- Core concept and terminology for strings.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing strings.
...
1. Implement a beginner-level strings exercise.
...
1. What is strings and why does it matter?
2. What are common pitfalls in strings?
3. How do you test and validate strings behavior?
4. How does strings affect performance?
5. What design principles apply most strongly to strings?
