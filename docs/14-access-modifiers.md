...
- Core concept and terminology for access modifiers.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing access modifiers.
...
1. Implement a beginner-level access modifiers exercise.
...
1. What is access modifiers and why does it matter?
2. What are common pitfalls in access modifiers?
3. How do you test and validate access modifiers behavior?
4. How does access modifiers affect performance?
5. What design principles apply most strongly to access modifiers?
