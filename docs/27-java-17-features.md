...
- Core concept and terminology for java 17 features.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing java 17 features.
...
1. Implement a beginner-level java 17 features exercise.
...
1. What is java 17 features and why does it matter?
2. What are common pitfalls in java 17 features?
3. How do you test and validate java 17 features behavior?
4. How does java 17 features affect performance?
5. What design principles apply most strongly to java 17 features?
