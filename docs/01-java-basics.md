...
- Core concept and terminology for java basics.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing java basics.
...
1. Implement a beginner-level java basics exercise.
...
1. What is java basics and why does it matter?
2. What are common pitfalls in java basics?
3. How do you test and validate java basics behavior?
4. How does java basics affect performance?
5. What design principles apply most strongly to java basics?
