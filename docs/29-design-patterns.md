...
- Core concept and terminology for design patterns.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing design patterns.
...
1. Implement a beginner-level design patterns exercise.
...
1. What is design patterns and why does it matter?
2. What are common pitfalls in design patterns?
3. How do you test and validate design patterns behavior?
4. How does design patterns affect performance?
5. What design principles apply most strongly to design patterns?
