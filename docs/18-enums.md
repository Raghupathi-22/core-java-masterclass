...
- Core concept and terminology for enums.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing enums.
...
1. Implement a beginner-level enums exercise.
...
1. What is enums and why does it matter?
2. What are common pitfalls in enums?
3. How do you test and validate enums behavior?
4. How does enums affect performance?
5. What design principles apply most strongly to enums?
