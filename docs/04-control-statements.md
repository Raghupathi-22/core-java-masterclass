...
- Core concept and terminology for control statements.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing control statements.
...
1. Implement a beginner-level control statements exercise.
...
1. What is control statements and why does it matter?
2. What are common pitfalls in control statements?
3. How do you test and validate control statements behavior?
4. How does control statements affect performance?
5. What design principles apply most strongly to control statements?
