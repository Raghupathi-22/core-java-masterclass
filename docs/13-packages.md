...
- Core concept and terminology for packages.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing packages.
...
1. Implement a beginner-level packages exercise.
...
1. What is packages and why does it matter?
2. What are common pitfalls in packages?
3. How do you test and validate packages behavior?
4. How does packages affect performance?
5. What design principles apply most strongly to packages?
