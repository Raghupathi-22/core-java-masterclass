...
- Core concept and terminology for garbage collection.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing garbage collection.
...
1. Implement a beginner-level garbage collection exercise.
...
1. What is garbage collection and why does it matter?
2. What are common pitfalls in garbage collection?
3. How do you test and validate garbage collection behavior?
4. How does garbage collection affect performance?
5. What design principles apply most strongly to garbage collection?
