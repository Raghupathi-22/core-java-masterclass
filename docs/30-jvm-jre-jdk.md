...
- Core concept and terminology for jvm, jre, jdk.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing jvm, jre, jdk.
...
1. Implement a beginner-level jvm, jre, jdk exercise.
...
1. What is jvm, jre, jdk and why does it matter?
2. What are common pitfalls in jvm, jre, jdk?
3. How do you test and validate jvm, jre, jdk behavior?
4. How does jvm, jre, jdk affect performance?
5. What design principles apply most strongly to jvm, jre, jdk?
