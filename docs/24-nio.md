...
- Core concept and terminology for nio.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing nio.
...
1. Implement a beginner-level nio exercise.
...
1. What is nio and why does it matter?
2. What are common pitfalls in nio?
3. How do you test and validate nio behavior?
4. How does nio affect performance?
5. What design principles apply most strongly to nio?
