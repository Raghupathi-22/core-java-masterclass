...
- Core concept and terminology for oop.
- Typical API/components used in production.
- Common mistakes and how to avoid them.

## 2. Notes

- Follow SOLID, DRY, KISS while implementing oop.
...
1. Implement a beginner-level oop exercise.
...
2. What are common pitfalls in oop?
3. How do you test and validate oop behavior?
4. How does oop affect performance?
5. What design principles apply most strongly to oop?
